...
public final class ReflectUtil {
    ...
    public static ReflectUtil init(@NonNull final String name) {
        return init(forName(name));
    }

    public static ReflectUtil init(@NonNull final String name, @NonNull final ClassLoader classLoader) {
        return init(forName(name, classLoader));
    }

    public static ReflectUtil init(@NonNull final Class<?> clazz) {
        return new ReflectUtil(clazz);
    }

    public static ReflectUtil init(@NonNull final Object object) {
        return new ReflectUtil(object.getClass(), object);
    }

    private static ReflectUtil init(Class<?> type, Object object) {
    ...
    public ReflectUtil set(String name, Object value) {
        try {
     ...
     */
    public ReflectUtil call(String name) {
     ...
     * @throws RuntimeException If any reflection exception occurred.
     */
    public ReflectUtil call(String name, Object... args) {
     ...
     */
    private static ReflectUtil init(Constructor<?> constructor, Object... args) {
        try {
     ...
     */
    private static ReflectUtil init(Method method, Object object, Object... args) {
        try {
            accessible(method);
